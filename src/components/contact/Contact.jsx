                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <a href="mailto:yusoofjnr@gmail.com" className="contact__button">Write me {" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://wa.me/08078678587" className="contact__button">Write me {" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        ...
                        <div className="contact__card">
                            ...
                            <a href="https://twitter.com/messages/989749237-1242191814775525381" className="contact__button">Write me {" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
